    ...
    <div>
        <div>
            ...
            <div>
                ...
                <div className='flex pt-2'>
                    <div>
                    <img className='w-96 pl-10 pt-6' src='/assets/ProjectsPics/oMERCADO/homepage.png' />
                    </div>
                    <div>
                    <img className='w-96 pl-10 pt-6' src='/assets/ProjectsPics/oMERCADO/main view.png' />
                    </div>
                    <div>
                    <img className='w-96 pl-10 pt-6' src='/assets/ProjectsPics/oMERCADO/client dashboard.png' />
                    </div>
                </div>
            </div>
        ...
        <div>
            ...
            <div>
                ...
                <div className='flex pt-2'>
                    <div>
                    <img className='w-96 pl-10 pt-6' src='/assets/ProjectsPics/TuneTracker/tt main page.png' />
                    </div>
                    <div>
                    <img className='w-96 pl-10 pt-6' src='/assets/ProjectsPics/TuneTracker/tt album.png' />
                    </div>
                    <div>
                    <img className='w-96 pl-10 pt-6' src='/assets/ProjectsPics/TuneTracker/tt my albums.png' />
                    </div>
                </div>
            </div>
        ...
        <div className='mb-24'>
            ...
            <div>
                ...
                <div className='flex pt-2'>
                    <div>
                    <img className='w-96 pl-10 pt-6' src='/assets/ProjectsPics/Pt Food Ninja/fn main.png' />
                    </div>
                    <div>
                    <img className='w-96 pl-10 pt-6' src='/assets/ProjectsPics/Pt Food Ninja/fn game.png' />
                    </div>
                    <div>
                    <img className='w-96 pl-10 pt-6' src='/assets/ProjectsPics/Pt Food Ninja/fn game over.png' />
                    </div>
                </div>
            </div>
