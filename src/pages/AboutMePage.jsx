		...
		<div className="flex flex-col min-h-screen">
			<div className='flex-grow'>
				...
				<p className='pl-36 text-justify w-4/5 leading-7 mt-8'>
					...
					goal-oriented learner with a passion for problem-solving. I found a
					lot of creativity and logical thinking in the process of developing
					websites that kept me motivated and brought reassurance that it is
					where I want my career to be going. At the moment, I am working on
					personal projects and looking for a job where I could apply all my
					skills and keep growing profesionally.
					<br /> <br /> If you would like to learn more about my story, feel
					free to connect
					<a href='/contact'>
						<span className='text-[#7b12ff] font-semibold'> HERE</span>
					</a>
					.
					<br />
					<br /> Check my work in the
					<a href='/projects'>
						<span className='text-[#7b12ff] font-semibold'> PROJECTS </span>
					</a>
					tab.
				</p>
			</div>
